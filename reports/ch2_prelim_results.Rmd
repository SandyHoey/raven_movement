...
boot_param_CI(nsim = 1, model = mod_terr_bms, data = ws_model_data)[[3]]
```
```{r (1) bootstrap (season), echo=FALSE, warning=FALSE}
#bootstrapping parameter values from model simulations
boot_param_CI(nsim = 1, model = mod_terr_hseason, data = ws_model_data)[[3]]
```
...
#bootstrapping parameter values from model simulations
boot_param_CI(nsim = 1, model = mod_hunt_bms, data = hunt_model_data)[[3]]
```
