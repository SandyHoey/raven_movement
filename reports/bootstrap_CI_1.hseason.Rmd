...
cov_labs <- c("Hunting Season", "Wolf Kill", "Distance",
              "Proportion Traveling", "Kill Density", "Snow Depth",
              "Max Temp", "Study Period", "Study Period * Max Temp")

#bootstrapping parameter values from model simulations
boot_param_CI(nsim = 10000, model = mod_terr_hseason, data = ws_model_data)[[3]] +
